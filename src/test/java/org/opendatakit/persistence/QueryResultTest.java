...
import org.opendatakit.persistence.QueryResult;
...
public class QueryResultTest {
  ...
  public void oneTimeSetUp() throws Exception {
    ...
    MyRelation rel = MyRelation.assertRelation(callingContext);
    ...
    rel = MyRelation.assertRelation(callingContext);
  ...
  static class MyRelation extends CommonFieldsBase {
    ...
    static final DataField fieldStr =
        new DataField("THIS_IS_IT", DataField.DataType.STRING, true, 90L);
    static final DataField fieldInt =
        new DataField("SECOND_FIELD", DataField.DataType.INTEGER, true);
    static final DataField fieldDbl =
        new DataField("THIRD_FIELD", DataField.DataType.DECIMAL, true);
    static final DataField fieldDate =
        new DataField("FOURTH_FIELD", DataField.DataType.DATETIME, true);
    static final DataField fieldBool =
        new DataField("FIFTH_FIELD", DataField.DataType.BOOLEAN, true);
    ...
    public void print() {
      System.out
          .println("PK " + getUri() + " " + fieldStr.getName() + " " + getStringField(fieldStr)
              + " " + getLongField(fieldInt) + " " + getNumericField(fieldDbl) + " "
              + getDateField(fieldDate) + " " + getBooleanField(fieldBool));
    }

    static synchronized final MyRelation assertRelation(CallingContext cc)
