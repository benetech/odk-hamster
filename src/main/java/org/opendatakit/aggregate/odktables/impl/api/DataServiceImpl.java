...
public class DataServiceImpl implements DataService {
  ...
  @Override
  public Response getRows(@QueryParam(CURSOR_PARAMETER) String cursor,
      @QueryParam(FETCH_LIMIT) String fetchLimit, @QueryParam(SORT_COLUMN) String sortColumn, @QueryParam(ASCENDING) Boolean ascending,
      @QueryParam(DEVICE_ID) String deviceId, @QueryParam(OFFICE_ID) String officeId)
    ...
    WebsafeRows websafeResult = dm.getRows(QueryResumePoint.fromWebsafeCursor(WebUtils.safeDecode(cursor)), limit, sortColumn, asc, deviceId, officeId);
