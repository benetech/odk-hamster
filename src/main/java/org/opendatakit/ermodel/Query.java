...
import org.opendatakit.ermodel.Relation.RelationImpl;
...
public class Query {
   ...
   */
  private org.opendatakit.persistence.Query query;

  protected Query(Relation relation, org.opendatakit.persistence.Query query) {
